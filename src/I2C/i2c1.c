...
void I2C1Init (uint8_t OwnAdress,uint32_t ClockSpeed,i2c_rcv_handler rh,i2c_rcv_handler mh, i2c_trans_handler st){
	...
	I2C1_GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8 | GPIO_Pin_9;
	I2C1_GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;
	I2C1_GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	I2C1_GPIO_InitStructure.GPIO_OType = GPIO_OType_OD;
	I2C1_GPIO_InitStructure.GPIO_PuPd =  GPIO_PuPd_UP;
	...
	I2C1_InitStructure.I2C_OwnAddress1 = OwnAdress<<1;
	...
	I2C1_NVIC_InitStructure.NVIC_IRQChannel = I2C1_EV_IRQn;
	I2C1_NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 0;
	I2C1_NVIC_InitStructure.NVIC_IRQChannelSubPriority = 0;
	I2C1_NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
	NVIC_Init(&I2C1_NVIC_InitStructure);

	I2C1_NVIC_InitStructure.NVIC_IRQChannel = I2C1_ER_IRQn;
	I2C1_NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 0;
	I2C1_NVIC_InitStructure.NVIC_IRQChannelSubPriority = 0;
	I2C1_NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
	NVIC_Init(&I2C1_NVIC_InitStructure);
